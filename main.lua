...
-------------desenha personagens----------------
		love.graphics.draw(ironman,love.mouse.getX()-50, love.mouse.getY()-50)
		love.graphics.circle("line", love.mouse.getX(),love.mouse.getY(), iron.s:getRadius() ,50, 30 )
---------------------------------------------------
